--[[
    Script: Sasiperere.lua (Versão com Correção Definitiva do Hook)
    [!] CORREÇÃO FINAL (Arma): A 'hookfunction' não fica mais sempre ativa.
    Agora, o hook é CRIADO apenas quando o Silent Aim é LIGADO, e é
    COMPLETAMENTE DESTRUÍDO com 'unhookfunction' quando é DESLIGADO.
    Isso garante que a arma SEMPRE atire quando o Silent Aim estiver OFF.
]]
...
local success, err = pcall(function() BulletModule = require(ReplicatedStorage.Modules.FPS.Bullet) end)
if not success then warn("Módulo de Bala do Project Delta não encontrado.") end
